        ...
        <section className='presentation' id={id}>
            ...
            <article className='pProfile'>
                <div className='pTrader'>
                    ...
                    <h2 className='pName'>Juan Giavovino</h2>
                </div>

                <p className='pDescription'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur harum, qui beatae earum rerum fugit iusto eaque adipisci nostrum amet enim odio quibusdam quos nesciunt reprehenderit hic? Molestiae necessitatibus et enim repellat eligendi rerum expedita itaque at magnam beatae, aspernatur facilis magni ullam, tempora dicta. Vero voluptatibus quidem qui quos.</p>
